...
library(gdata)
credit_card <- read.xls("/Users/R Workspace/Mid Term/Problem 1/credit card.xls")
...
#write file to csv
write.csv(card, file="/ R Workspace/Mid Term/Problem 1/Output/credit.csv", row.names = F)
...
filename = "/ R Workspace/Mid Term/Problem 1/PredictionPerformanceMetrics_Problem1.csv"
