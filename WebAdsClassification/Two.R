...
#write to csv file
write.csv(dataset, file="/R Workspace/Mid Term/Problem 2/ad-dataset/InternetADs.csv", row.names = F)
...
write.csv(dataset, file="/R Workspace/Mid Term/Problem 2/ad-dataset/InternetADs_revised.csv", row.names = F)
